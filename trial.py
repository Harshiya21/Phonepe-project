...
if select_options == "INSIGHTS":
    ...
    if questions == "1.Top 10 States Amount Transactions":
    ...
    elif questions == "3.Least 10 Pincodes along with States Least 10 Pincodes along with States Total Transactions":
        mycursor.execute('USE phonepae')
        ...
        st.write(df9)
        fig_sunburst_3 = px.sunburst(df9, path=["State","Pincodes"], values="RegisteredUsers",
